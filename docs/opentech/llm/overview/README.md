...
| [Lab 1: Configuring Open-WebUI](../lab-1/README.md)                       | Set up Open-WebUI to start using an LLM locally |
...
| [Lab 5: Using Open-WebUI for a local RAG](../lab-5/README.md)               | Write code using Continue and Granite |
...
* These labs are based on the originals [here](https://github.com/IBM/opensource-ai-workshop/pulls)
